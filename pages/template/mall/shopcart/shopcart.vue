	...
	<view class="container">
						...
						<view class="tui-goods-item">
							...
							<view class="tui-goods-info">
								...
								<view class="tui-price-box">
									<view class="tui-goods-price">￥{{getPrice(item.price)}}</view>
		...
		<view class="tui-cart-cell  tui-mtop">
			<view class="tui-activity">
				...
				<view class="tui-buy">
					<tui-button type="gray" :plain="true" shape="circle" width="200rpx" height="56rpx" :size="24">清空失效商品
					</tui-button>
				</view>
			</view>
				...
				<tui-swipe-action :actions="actions2">
					<template v-slot:content>
						<view class="tui-goods-item">
							...
							<image src="/static/images/mall/product/4.jpg" class="tui-goods-img opcity"></image>
							<view class="tui-goods-info">
								...
								<view class="tui-price-box tui-flex-center">
									...
									<view class="tui-btn-alike">
										<tui-button type="white" :plain="true" shape="circle" width="120rpx"
											height="48rpx" :size="24">找相似</tui-button>
									</view>
								</view>
							</view>
						</view>
		...
		<view class="tui-tabbar">
			<view class="tui-checkAll">
				...
				<view class="tui-total-price" v-if="!isEdit">合计:<text class="tui-bold">￥{{getPrice(totalPrice)}}</text>
				</view>
			</view>
			<view>
				<tui-button width="200rpx" height="70rpx" :size="30" type="danger" shape="circle" v-if="!isEdit"
					@click="btnPay">去结算({{buyNum}})</tui-button>
				<tui-button width="200rpx" height="70rpx" :size="30" type="danger" shape="circle" :plain="true" v-else>
					删除</tui-button>
			</view>
		</view>
		<!--加载loadding-->
