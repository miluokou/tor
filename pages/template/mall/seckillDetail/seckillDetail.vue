			...
			<view class="tui-product-title tui-border-radius">
				<view class="tui-price__box">
					...
					<view class="tui-right__box">
						<image v-if="status!=2" src="https://gogo.miluokou.com/images/mall/img_seckillgood_seckill.png" class="tui-seckill__img"
						 mode="widthFix"></image>
				...
				<view class="tui-flex-1" v-if="status==3">
					<tui-button height="68rpx" :size="26" :type="remind==1?'warning':'green'" shape="circle" @click="btnRemind">
						<view class="tui-right-flex">
							<image v-if="remind==1" src="https://gogo.miluokou.com/images/mall/img_clock.png" class="tui-img__clock"></image>
